<?php
/**
 * Template Name: MarsX Register (English)
 * Description: Registration page for MarsX Things - English version
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['marsx_register'])) {
    ...
    if (!isset($_POST['marsx_register_nonce']) || !wp_verify_nonce($_POST['marsx_register_nonce'], 'marsx_register_action')) {
        ...
        if (empty($first_name) || empty($last_name)) {
            $register_error = 'Please enter your first and last name.';
        } elseif (empty($email) || !is_email($email)) {
            $register_error = 'Please enter a valid email address.';
        } elseif (email_exists($email)) {
            $register_error = 'This email is already registered.';
        } elseif (strlen($password) < 12) {
            $register_error = 'Password must be at least 12 characters long.';
            ...
            if (is_wp_error($user_id)) {
                ...
                marsx_send_verification_email($user_id, 'en');

                // Redirect to login page with success message
                wp_redirect(home_url('/en/login/?registered=1&email=' . urlencode($email)));
                exit;
            }
        }
        }
    ...
    <div class="register-container">
        ...
        <div class="register-left">
            <div class="register-left-content">
                ...
                <p>Already have an account?<br>You can <a href="<?php echo esc_url($login_url); ?>">sign in here!</a></p>
            </div>
        </div>
        ...
        <div class="register-right">
            ...
            <div class="lang-switch">
                <a href="<?php echo home_url('/register/'); ?>" title="ภาษาไทย">
            ...
            <div class="register-form-wrapper">
                ...
                <p class="subtitle">Sign up to start shopping with us</p>
                ...
                <form method="post" action="" id="register-form">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="first_name" name="first_name" placeholder="Your first name" value="<?php echo isset($_POST['first_name']) ? esc_attr($_POST['first_name']) : ''; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="last_name">Last Name</label>
                            <input type="text" id="last_name" name="last_name" placeholder="Your last name" value="<?php echo isset($_POST['last_name']) ? esc_attr($_POST['last_name']) : ''; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-wrapper">
                            ...
                            <button type="button" class="password-toggle" onclick="togglePassword('password')" aria-label="Show/hide password">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-wrapper">
                            ...
                            <button type="button" class="password-toggle" onclick="togglePassword('confirm_password')" aria-label="Show/hide password">
                    ...
                    <div class="password-options">
                        <div class="password-options-title">Password Policy</div>
                    ...
                    <button type="submit" name="marsx_register" class="btn-register" id="btn-register">Create Account</button>
                </form>
