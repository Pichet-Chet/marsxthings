<?php
/**
 * Template Name: MarsX Cart (English)
 * Description: Cart page for MarsX Things - English
 */
...
<div class="mcart">
    <div class="mcart-inner">
        ...
        <div class="mcart-empty">
            ...
            <a href="<?php echo home_url('/en/products/'); ?>" class="mcart-btn">Start Shopping</a>
        </div>
        ...
        <form action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post" id="cart-form">
            ...
            <div class="mcart-grid">
                <div class="mcart-list">
                    ...
                    <div class="mcart-item">
                        ...
                        <div class="mcart-info">
                            ...
                            <p class="price"><?php echo WC()->cart->get_product_price($product); ?> each</p>
                        </div>
                ...
                <div class="mcart-summary">
                    ...
                    <div class="mcart-row">
                        <span class="label">Subtotal (<?php echo $cart->get_cart_contents_count(); ?> items)</span>
                    ...
                    <a href="<?php echo esc_url(wc_get_checkout_url()); ?>" class="mcart-btn">Proceed to Checkout</a>
                    <a href="<?php echo home_url('/en/products/'); ?>" class="mcart-continue">← Continue Shopping</a>
                </div>
            </div>
