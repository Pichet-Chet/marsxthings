    ...
    <div class="marsx-cart-container">
        ...
        <?php if ($cart->is_empty()) : ?>
            ...
            <div class="marsx-empty-cart">
                ...
                <p>You haven't added any items to your cart yet. Start shopping now!</p>
                ...
                <div class="marsx-cart-layout">
                        ...
                        <?php foreach ($cart->get_cart() as $cart_item_key => $cart_item) :
                            ...
                            if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) :
                                ...
                                <div class="marsx-cart-item" data-key="<?php echo esc_attr($cart_item_key); ?>">
                                    ...
                                    <!-- Remove -->
                                    <a href="<?php echo esc_url(wc_get_cart_remove_url($cart_item_key)); ?>" class="marsx-item-remove" title="Remove item">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="marsx-cart-summary">
                        ...
                        <div class="marsx-summary-row">
                            <span class="marsx-summary-label">Subtotal (<?php echo $cart->get_cart_contents_count(); ?> items)</span>
                            <span class="marsx-summary-value"><?php echo $cart->get_cart_subtotal(); ?></span>
                        </div>

                        <?php if ($cart->get_cart_discount_total() > 0) : ?>
                            <div class="marsx-summary-row">
                                <span class="marsx-summary-label">Discount</span>
                        ...
                        <div class="marsx-summary-row total">
                            <span class="marsx-summary-label">Total</span>
