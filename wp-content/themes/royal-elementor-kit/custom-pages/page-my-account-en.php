...
<style>
    .marsx-account-wrapper { font-family: 'Poppins', -apple-system, BlinkMacSystemFont, sans-serif; background: #f8f9fa; min-height: 60vh; padding: 40px 0; }
            ...
            <?php if ($current_tab === 'dashboard') : ?>
                <div class="marsx-content-card">
                    ...
                    <div class="marsx-back-to-shop">
                        <a href="<?php echo home_url('/en/shop/'); ?>">
