<?php
/**
 * Template Name: MarsX Thank You (English)
 * Description: Thank you page after successful order - English
 */
    ...
    <div class="marsx-thankyou-container">
        <?php if ($order) : ?>
            ...
            <div class="marsx-success-header">
                ...
                <h1 class="marsx-success-title">Thank You for Your Order!</h1>
                <p class="marsx-success-subtitle">We have received your order and will process it as soon as possible.</p>
            </div>
            ...
            <div class="marsx-order-card">
                ...
                <div class="marsx-order-body">
                    ...
                    <div class="marsx-order-items">
                        ...
                        ?>
                            <div class="marsx-order-item">
                                ...
                                <div class="marsx-item-price"><?php echo number_format($item->get_total(), 0); ?> Baht</div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="marsx-order-totals">
                        ...
                        <div class="marsx-total-row">
                            <span class="marsx-total-label">Shipping</span>
        ...
        <?php else : ?>
            ...
            <div class="marsx-error-card">
                ...
                <p class="marsx-error-message">Unable to access order information. Please check the link or log in to view your orders.</p>
                <div class="marsx-actions">
                    <a href="<?php echo home_url('/en/products/'); ?>" class="marsx-btn-primary">Back to Shop</a>
                    <?php if (!is_user_logged_in()) : ?>
                    <a href="<?php echo home_url('/en/login/'); ?>" class="marsx-btn-secondary">Log In</a>
                    <?php endif; ?>
                </div>
            </div>
        <?php endif; ?>
