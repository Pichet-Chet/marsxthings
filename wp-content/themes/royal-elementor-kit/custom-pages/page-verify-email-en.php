<?php
/**
 * Template Name: MarsX Verify Email (English)
 * Description: Email verification page for MarsX Things - English
 */
...
<head>
    ...
    <title>Verify Email - <?php bloginfo('name'); ?></title>
    ...
    <div class="verify-container">
        ...
        <div class="verify-card">
            ...
            <?php elseif ($page_status === 'already_verified') : ?>
                ...
                <h2 class="verify-title">Already Verified</h2>
                <p class="verify-message">
            ...
            <?php elseif ($page_status === 'expired') : ?>
                ...
                <h2 class="verify-title">Link Expired</h2>
                <p class="verify-message">
                    This verification link has expired.<br>
                    Please go to the login page to request a new link.
                </p>
                <a href="<?php echo esc_url($login_url); ?>" class="btn-primary">
                    Go to Login
                </a>
            ...
            <?php else : ?>
                ...
                <h2 class="verify-title">Invalid Link</h2>
                <p class="verify-message">
